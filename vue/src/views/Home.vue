...
export default {
  ...
  methods: {
    load(){
      // this.request.get(`http://localhost:9090/user/page?pageNum=${this.pageNum}&pageSize=${this.pageSize}&fname=${this.fname}`).then(res =>{
      //    console.log(res);
      //   console.log("xxx")
      ...
      // fetch(`http://localhost:9090/user/page?pageNum=${this.pageNum}&pageSize=${this.pageSize}&fname=${this.fname}`).then(res => res.json()).then(res =>{
      // console.log(res);
