<template>
  <div>
    ...
    <div style="margin: 10px 0">
      ...
      <el-upload :action="'http://' + serverIp + ':9090/file/upload'" :show-file-list="false" :headers="headers"
...
// 这里引入外部js文件后，还需要在vue中写一个变量，这样上面的dom元素才能用，上面的html用vue的元素，而用不了引进来的js值
export default {
  name: "File",
  data() {
    return {
