      ...
      <div style="margin: 100px auto; background-color: #fff; width: 350px; height: 400px; padding: 20px; border-radius: 10px">
        ...
        <el-form :model="user" :rules="rules" ref="userForm">
          ...
          <el-form-item prop="fname">
            <el-input size="medium" placeholder="请输入账号 " tyle="margin: 10px 0" prefix-icon="el-icon-user" v-model="user.fname"></el-input>
          </el-form-item>
          <el-form-item prop="remark">
            <el-input size="medium" placeholder="请输入密码 " style="margin: 10px 0" prefix-icon="el-icon-lock" show-password v-model="user.remark"></el-input>
          </el-form-item>
          <el-form-item prop="confirmRemark">
            <el-input size="medium" placeholder="请确认密码 " style="margin: 10px 0" prefix-icon="el-icon-lock" show-password v-model="user.confirmRemark"></el-input>
          </el-form-item>
